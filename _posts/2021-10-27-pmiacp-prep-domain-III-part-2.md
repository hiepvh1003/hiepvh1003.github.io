---
layout: post
title:  "PMI ACP Prep Test Question - Domain III - Part 2"
author: hiepvh
categories: [ PMI ACP ]
tags: [ pmi-acp, pm ]
...
<div id="titleBlock" style="text-align: center;">
  <h4 style="margin-bottom: 0px;"> PREP TEST QUESTION - DOMAIN III - PART 2</h4>
  <hr style="width: 50%;">
</div>

{:#tblContent}
| PREP TEST QUESTION - DOMAIN IIII |
|-----|
...
{% for ques in site.data.domain003.questions limit:10 offset:9 %}
<!-- QUESTION -->
<div class="text-card">
  <div class="heading">
