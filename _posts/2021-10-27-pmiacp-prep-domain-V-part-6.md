---
layout: post
title:  "PMI ACP Prep Test Question - Domain V - Part 6"
author: hiepvh
categories: [ PMI ACP ]
tags: [ pmi-acp, pm ]
...
<div id="titleBlock" style="text-align: center;">
  <h4 style="margin-bottom: 0px;"> PREP TEST QUESTION - DOMAIN V - PART 6</h4>
  <hr style="width: 50%;">
</div>
...
{% for ques in site.data.domain005.questions limit:11 offset:49 %}
<!-- QUESTION -->
<div class="text-card">
  <div class="heading">
